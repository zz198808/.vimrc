...
func SetTitle()
    ...
    if &filetype == 'sh'
        ...
        call append(line("."), "# Author:terazhang")
        call append(line(".")+1, "# Version:0.1")
        call append(line(".")+4, "")
    elseif &filetype == 'cpp'
        call setline(1,"/***************************************************************************")
        call append(line("."), "*")
        call append(line(".")+1, "* Copyright (c) 2010 Baidu.com, Inc. All Rights Reserved")
        call append(line(".")+2, "*")
        call append(line(".")+3, "*")
        call append(line(".")+4, "/***************************************************************************")
        call append(line(".")+5, "")
        call append(line(".")+6, "")
        call append(line(".")+7, "/**")
        call append(line(".")+8, "* @File Name: ".expand("%"))
        call append(line(".")+9, "* @author: terazhang@tencent.com")
        call append(line(".")+10, "* @Created Time: ".strftime("%y/%m/%d %H:%M:%S"))
        call append(line(".")+11, "* version")
        call append(line(".")+12, "* brief")
        call append(line(".")+13, "*")
        call append(line(".")+14, "**/")
